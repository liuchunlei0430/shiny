                ...
                column(
                  width = 4,
                    box(
                      ...
                      status = "primary", 
                      solidHeader = TRUE,
                      style = "height: 400px;",        # 父容器固定总高度
                      width = 12, 
                      plotlyOutput("protocol_plot", height = "100%", width = "100%"),   # 让plotly填满父容器
                      actionButton("zoom_plot", "View Full Size", style = "margin-top: 10px;")
                    )
                ),
                column(
                  width = 8,
                ...
                tabPanel("Spatial Registration",
                  fluidRow(
                    column(12,
                      wellPanel(
                        fluidRow(
                          column(2, selectInput("spatial_data_source", "Data Source:", choices = c("All" = ""), selected = "")),
                          column(2, selectInput("spatial_protocol", "Protocol:", choices = c("All" = ""), selected = "")),
                          column(2, selectInput("spatial_modality", "Modality:", choices = c("All" = ""), selected = "")),
                          column(3, selectInput("spatial_species", "Species:", choices = c("All" = ""), selected = "")),
                          column(3, selectInput("spatial_tissue", "Tissue:", choices = c("All" = ""), selected = ""))
                        )
                      ),
                      DTOutput("spatial_dataset_table")
                    )
                  )
                )
              )
